...
def allGP(client, message,redis):
  ...
  if text :
    ...
    if re.search(c.sors,text):
      kb = InlineKeyboardMarkup([[InlineKeyboardButton("قناه السورس 📢", url="t.me/CXRCX")],[InlineKeyboardButton("تواصل السورس 💬", url="t.me/BBBVVBV")],[InlineKeyboardButton("شروحات السورس 📑", url="t.me/cxrcx")]])
